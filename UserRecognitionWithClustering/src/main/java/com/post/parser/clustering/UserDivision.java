...
public class UserDivision {
    ...
    /**
     * @Desc This function divides all the user into two users 
     * as A and B where (user:A + user:B) = total number of posts of the original (user:U)
     * @param userList
     * @return List<User>
     */
    ...
    /**
     * @Desc This function divides the first user into two users 
     * as A and B where (user:A + user:B) = total number of posts of the original (user:U).
     * Rest of the other users contain only half of the original post whereas other post has been removed.
     * @param userList
     * @return List<User>
     */
